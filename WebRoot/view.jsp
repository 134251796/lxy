  ...
  <body  background="images/003.jpg">
    ...
    <table width="443" border="1" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="400">
			<div align="center">
           		<input name="userName" type="text" id="yonghu" size="20" value=<%=session.getAttribute("userName")%>>
        	</div>
		</td>
      </tr>
      <tr>
        ...
        <td>
			<div align="center">
				<input name="gender" type="text" id="xinbie" size="20" value=<%=session.getAttribute("gender")%>>          
            </div>
		</td>
      </tr>
      <tr>
        ...
        <td>
			<div align="center">
          		<input name="tel" type="text" id="zhengjian" size="20" value=<%=session.getAttribute("tel")%>>
        	</div>
		</td>
      </tr>
      <tr>
        ...
        <td>
			<div align="center">
          		<input name="email" type="text" id="Emil" size="20" value=<%=session.getAttribute("email")%>>
        	</div>
		</td>
      </tr>
    </table>
