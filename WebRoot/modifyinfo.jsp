	...
	function User()
{
  ...
  <body background="images/003.jpg">
	...
	<center>
			<%
				String message = (String)session.getAttribute("Message") == null?"":(String)session.getAttribute("errorMessage");
	...
	<p>&nbsp;</p>
    <p>&nbsp;</p>
<form name="form1" method="post" action="NoparamServlet">
    <p>&nbsp;</p>
    ...
    <p align="center">
      <input type="submit" name="Submit" value="修改" onclick="User()"> 
